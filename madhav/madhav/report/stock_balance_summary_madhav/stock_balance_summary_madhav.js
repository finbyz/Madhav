...
frappe.query_reports["Stock Balance Summary Madhav"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
	...
	formatter: function (value, row, column, data, default_formatter) {
		...
		else if (column.fieldname == "manufacturer" && data && data.manufacturer ) {
		...
		else if (column.fieldname == "consumption" && data && data.consumption ) {
		...
		else if (column.fieldname == "purchase" && data && data.purchase) {		
			if (data.purchase > 0) {
				value = "<span style='color:green'>" + value + "</span>";
			}
			else {
		...
		else if (column.fieldname == "sales" && data && data.sales ) {
			if (data.sales > 0) {
				value = "<span style='color:green'>" + value + "</span>";
			}
			else {
